...
rel_hum_value=0.005:0.005:1.0;

num_iteration=length(rel_hum_value);
...
figure(1)
plot(mass_water,bwr,'LineWidth',2)
grid on
xlabel("Water Mass Flow Rate (kg/s)")
ylabel("Ratio (%)")
title('Parametric Analysis 1')
hold on
plot(mass_water,eta_cycle,'LineWidth',2)
